...
-- -----------------------------------------------------
-- Table `PupilBook`.`Roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PupilBook`.`Roles` ;

CREATE TABLE IF NOT EXISTS `PupilBook`.`Roles` (
  `Role` VARCHAR(10) NOT NULL,
  `Users_Login` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`Role`, `Users_Login`),
  INDEX `fk_Roles_Users1_idx` (`Users_Login` ASC),
