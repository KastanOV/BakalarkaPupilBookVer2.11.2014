...
import GeneratedSessionBeans.TeacherSubjectsFacade;
...
public class TeacherSubjectsController implements Serializable {
    ...
    @EJB
    private GeneratedSessionBeans.TeacherSubjectsFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TeacherSubjectsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TeacherSubjectsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TeacherSubjectsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
