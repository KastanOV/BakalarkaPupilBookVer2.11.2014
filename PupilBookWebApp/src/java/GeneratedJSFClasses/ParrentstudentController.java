...
import GeneratedSessionBeans.ParrentstudentFacade;
...
public class ParrentstudentController implements Serializable {
    ...
    @EJB
    private GeneratedSessionBeans.ParrentstudentFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ParrentstudentCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ParrentstudentUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ParrentstudentDeleted"));
        if (!JsfUtil.isValidationFailed()) {
