...
import GeneratedSessionBeans.InformationsFacade;
...
public class InformationsController implements Serializable {
    ...
    @EJB
    private GeneratedSessionBeans.InformationsFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("InformationsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("InformationsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("InformationsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
