...
import SessionBeans.SheduleitemFacade;
...
public class SheduleitemController implements Serializable {
    ...
    @EJB
    private SessionBeans.SheduleitemFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Names").getString("SheduleitemCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Names").getString("SheduleitemUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Names").getString("SheduleitemDeleted"));
        if (!JsfUtil.isValidationFailed()) {
