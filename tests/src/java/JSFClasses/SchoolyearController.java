...
import SessionBeans.SchoolyearFacade;
...
public class SchoolyearController implements Serializable {
    ...
    @EJB
    private SessionBeans.SchoolyearFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Names").getString("SchoolyearCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Names").getString("SchoolyearUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Names").getString("SchoolyearDeleted"));
        if (!JsfUtil.isValidationFailed()) {
