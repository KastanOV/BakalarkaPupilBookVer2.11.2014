...
public class AttendanceController implements Serializable {
    ...
    @EJB
    private SessionBeans.AttendanceFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Names").getString("AttendanceCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Names").getString("AttendanceUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Names").getString("AttendanceDeleted"));
        if (!JsfUtil.isValidationFailed()) {
