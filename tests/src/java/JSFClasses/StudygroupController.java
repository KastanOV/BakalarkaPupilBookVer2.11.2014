...
import SessionBeans.StudygroupFacade;
...
public class StudygroupController implements Serializable {
    ...
    @EJB
    private SessionBeans.StudygroupFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Names").getString("StudygroupCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Names").getString("StudygroupUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Names").getString("StudygroupDeleted"));
        if (!JsfUtil.isValidationFailed()) {
